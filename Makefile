...
INCLUDES	= $(addprefix $(INCL_DIR), Config.hpp ServerBlock.hpp LocationBlock.hpp Tokeniser.hpp)


# Source files
SRCS_DIR	= config_parser/srcs/
SRC			= $(addprefix $(SRCS_DIR), Config.cpp ServerBlock.cpp LocationBlock.cpp Tokeniser.cpp main.cpp)
